...
(function($) {
    ...
    THEMEMASCOT.initialize = {
        ...
        TM_loadBSParentModal: function() {
            ...
            if( ajaxLoadContent ) {
                $.ajax({
                    url: "http://54.146.177.95/static/stanford-style/ajax-load/bootstrap-parent-modal.html",
    ...
    THEMEMASCOT.header = {
        ...
        TM_sidePushPanelContent: function() {
            if( $body.hasClass('has-side-panel') ) {
                $.ajax({
                    url: "http://54.146.177.95/static/stanford-style/ajax-load/side-push-panel-content.html",
                    success: function (data) { $body.append(data); },
                    dataType: 'html'
                });
            }
