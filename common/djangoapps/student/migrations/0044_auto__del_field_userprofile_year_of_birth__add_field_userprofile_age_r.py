...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.age_range'
        db.add_column('auth_userprofile', 'age_range',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=12, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('auth_userprofile', 'year_of_birth',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=12, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'UserProfile.age_range'
        db.delete_column('auth_userprofile', 'age_range')
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'age_range': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '12', 'null': 'True', 'blank': 'True'}),
