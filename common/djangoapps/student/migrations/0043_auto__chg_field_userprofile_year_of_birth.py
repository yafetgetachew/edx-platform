...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.year_of_birth'
        db.alter_column('auth_userprofile', 'year_of_birth', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.year_of_birth'
        db.alter_column('auth_userprofile', 'year_of_birth', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'year_of_birth': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '12', 'null': 'True', 'blank': 'True'})
        },
