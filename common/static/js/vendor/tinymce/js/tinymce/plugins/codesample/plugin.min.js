	...
	highlightAll: function(async, callback) {
		...
		for (var i=0, element; element = elements[i++];) {
			_.highlightElement(element, async === true, callback);
                        //var language = element.classList.item('language-').replace('language-', '');
		...
		editor.undoManager.transact(function() {
			...
			if (node) {
				...
				Prism.highlightElement(node);
                                //var language = node.classList.item('language-').replace('language-', '');
...
define("tinymce/codesampleplugin/Plugin", [
	...
	PluginManager.add('codesample', function(editor, pluginUrl) {
		...
		function loadCss() {
			var linkElm;
			if (editor.getDoc().querySelectorAll('link').length <= 1) {
				linkElm = editor.dom.create('link', {
					rel: 'stylesheet',
					href: editor.settings.codesample_hljs_css
				});
				...
				editor.undoManager.transact(function() {
					unprocessedCodeSamples.each(function(idx, elm) {
						...
						Prism.highlightElement(elm);
                                                //var language = elm.classList.item('language-').replace('language-', '');
                                                //elm.classList.add(language);
