    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                colors: ["#edc240", "#afd8f8", "#268839", "#4da74d", "#9440ed"],
                legend: {
                    show: true,
        ...
        function fillInSeriesOptions() {
            ...
            while (colors.length < neededColors) {
                ...
                c.scale('rgb', 1 + sign * Math.ceil(variation / 8) * 0.2)
