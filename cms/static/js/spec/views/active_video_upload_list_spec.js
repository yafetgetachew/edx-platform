...
define(
    ...
    function($, ActiveVideoUpload, ActiveVideoUploadListView, StringUtils, TemplateHelpers, AjaxHelpers) {
        ...
        var concurrentUploadLimit = 2,
            ...
            videoMaxLengthFileName = 36,
            availableStorageService = 'aws',
        ...
        describe('ActiveVideoUploadListView', function() {
            ...
            it('called uploadAzureStorage when availableStorageService is equal to value azure', function() {
                var uploadData = {
                    files: [{name: 'video.mp4', size: 10000}],
                    redirected: true
                };
                this.view.availableStorageService = 'azure';
                    ...
                    _.each(this.view.itemViews, function(uploadView) {
                        verifyUploadViewInfo(
                            ...
                            StringUtils.interpolate(
                                ...
                                {maxLengthFileName: self.view.videoMaxLengthFileName}
                            )
                        );
                    });
                });
