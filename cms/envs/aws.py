...
REGISTRATION_EMAIL_PATTERNS_ALLOWED = ENV_TOKENS.get('REGISTRATION_EMAIL_PATTERNS_ALLOWED', REGISTRATION_EMAIL_PATTERNS_ALLOWED)
...
if FEATURES.get('ENABLE_THIRD_PARTY_AUTH'):
    ...
    INSTALLED_APPS += ('third_party_auth', )
