    ...
    def get_certificate_white_list(cls, course_id, student=None):
        ...
        for item in white_list:
            ...
            result.append({
                ...
                'created': item.created.strftime("%m/%d/%Y"),
                'certificate_generated': certificate_generated and certificate_generated.strftime("%m/%d/%Y"),
    ...
    def get_certificate_invalidations(cls, course_key, student=None):
        ...
        for certificate_invalidation in certificate_invalidations:
            data.append({
                ...
                'created': certificate_invalidation.created.strftime("%m/%d/%Y"),
