...
PLATFORM_TWITTER_ACCOUNT = ENV_TOKENS.get('PLATFORM_TWITTER_ACCOUNT', '@kwneducation')
PLATFORM_FACEBOOK_ACCOUNT = ENV_TOKENS.get('PLATFORM_FACEBOOK_ACCOUNT', 'https://www.facebook.com/kwneducation/')
PLATFORM_LINKEDIN_ACCOUNT = ENV_TOKENS.get('PLATFORM_LINKEDIN_ACCOUNT', 'https://www.linkedin.com/company/kwn-education')
PLATFORM_INSTAGRAM_ACCOUNT = ENV_TOKENS.get('PLATFORM_INSTAGRAM_ACCOUNT', 'https://www.instagram.com/kwneducation/')
PLATFORM_YOUTUBE_ACCOUNT = ENV_TOKENS.get('PLATFORM_YOUTUBE_ACCOUNT', 'https://www.youtube.com/channel/UCrg6-OFF92tEo1mW5sJZ3Qw')
