...
if ENV_TOKENS.get('LMS_SESSION_COOKIE_NAME'):
    SESSION_COOKIE_NAME = str(ENV_TOKENS.get('LMS_SESSION_COOKIE_NAME'))
...
BETTA_TESTERS_ENABLE = ENV_TOKENS.get('BETTA_TESTERS_ENABLE', False)
