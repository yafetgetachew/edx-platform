...
PLATFORM_LINKEDIN_ACCOUNT = ENV_TOKENS.get('PLATFORM_LINKEDIN_ACCOUNT', PLATFORM_LINKEDIN_ACCOUNT)
PLATFORM_INSTAGRAM_ACCOUNT = ENV_TOKENS.get('PLATFORM_INSTAGRAM_ACCOUNT', PLATFORM_INSTAGRAM_ACCOUNT)
PLATFORM_YOUTUBE_ACCOUNT = ENV_TOKENS.get('PLATFORM_YOUTUBE_ACCOUNT', PLATFORM_YOUTUBE_ACCOUNT)
...
AUTH_SESSION_COOKIE_DOMAIN = ENV_TOKENS.get('AUTH_SESSION_COOKIE_DOMAIN')

ROOT_URLCONF = ENV_TOKENS.get('ROOT_URLCONF', ROOT_URLCONF)
