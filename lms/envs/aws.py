...
MIDDLEWARE_CLASSES += tuple(ENV_TOKENS.get('ADDL_MIDDLEWARE_CLASSES', []))
TEMPLATES[0]['DIRS'] = ENV_TOKENS.get('ADDL_TEMPLATES', []) + TEMPLATES[0]['DIRS']
MAKO_TEMPLATES['main'] = ENV_TOKENS.get('ADDL_TEMPLATES', []) + MAKO_TEMPLATES['main']

PORTAL_URL = ENV_TOKENS.get('PORTAL_URL', 'https://www.millionlights.org')
