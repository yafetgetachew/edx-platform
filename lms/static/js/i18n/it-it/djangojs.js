...
(function (globals) {
  ...
  django.catalog = {
    ...
    "%(post_type)s posted %(time_ago)s by %(author)s": "%(post_type)s postato %(time_ago)s da %(author)s", 
    "%(team_count)s Team": [
      "%(team_count)s Gruppi", 
      "%(team_count)s Gruppi"
    ], 
    ...
    "Already have an account?": "Possiedi gi\u00e0 un account?", 
    ...
    "Check the box to remove %(count)s flag.": [
      "Seleziona il box per rimuover %(counts)s flag.", 
    ...
    "Click to remove": "Clicca per rinuovere", 
    "Close": "Chiudi", 
    ...
    "Delete student '<%= student_id %>'s state on problem '<%= problem_id %>'?": "Cancellare lo stato dello studente '<%= student_id %>' sul problema '<%= problem_id %>'?", 
    ...
    "Error": "Errore", 
    "Error adding students.": "Errore nell'aggiungere gli studenti.", 
    ...
    "Error deleting student '<%= student_id %>'s state on problem '<%= problem_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Errore nella cancellazione dello stato dello studente '<%= student_id %>' sul problema '<%= problem_id %>'. Assicurati che gli identificatori del problema e dello studente siano completi e corretti.", 
    ...
    "Error getting student progress url for '<%= student_id %>'. Make sure that the student identifier is spelled correctly.": "Errore nell'ottenere l'url progresso per lo studente per '<%= student_id %>'. Assicurati che l'identificatore dello studente sia scritto correttamente.", 
    "Error getting task history for problem '<%= problem_id %>' and student '<%= student_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Errore nel recupero dello storico del problema '<%= problem_id %>' per lo studente '<%= student_id %>'. Verifica che gli identificativi del problema e dello studente siano completi e corretti.", 
    ...
    "Error resetting problem attempts for problem '<%= problem_id %>' and student '<%= student_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Errore nell'azzeramento dei tentativi per il problema'<%= problem_id %>' e lo studente '<%= student_id %>'. Verifica che gli identificativi del problema e dello studente siano completi e corretti.", 
    ...
    "Error starting a task to rescore problem '<%= problem_id %>' for student '<%= student_id %>'. Make sure that the the problem and student identifiers are complete and correct.": "Errore nel ricalcolo del punteggio del problema '<%= problem_id %>'per lo studente '<%= student_id %>'. Verifica che gli identificativi del problema e dello studente siano completi e corretti.", 
    "Error starting a task to rescore problem '<%= problem_id %>'. Make sure that the problem identifier is complete and correct.": "Errore nel ricalcolo dei punteggi per il problema  '<%= problem_id %>'. Verifica che l'identificativo dell'esercizio sia completo e corretto.", 
    "Error starting a task to reset attempts for all students on problem '<%= problem_id %>'. Make sure that the problem identifier is complete and correct.": "Errore nell'avvio delle operazioni di ripristino dei tentativi di tutti gli studenti per l'esercizio '<%= problem_id %>'. Verifica che l'identificativo dell'esercizio sia completo e corretto.", 
    ...
    "File": "File", 
    "File Name": "Nome File", 
    "File format not supported. Please upload a file with a {file_extension} extension.": "Formato del file non supportato. Per favore carica un file con estensione {file_extension} .", 
    ...
    "Loading thread list": "Caricamento della lista delle discussioni", 
    ...
    "No results found for {original_query}. ": "Nessun risultato trovato per {original_query}", 
    "No sources": "Non ci sono fonti", 
    "No tasks currently running.": "Nessuna attivit\u00e0 in corso in questo momento.", 
    "No threads matched your query.": "Nessun thread corrisponde alla query.", 
    ...
    "Profile image for {username}": "Immagine di profilo di {nome utente}", 
    "Public": "Pubblico", 
    "Publish": "Pubblica", 
    ...
    "Required field.": "Campo richiesto", 
    "Rescore problem '<%= problem_id %>' for all students?": "Ricalcolare il punteggio dell'esercizio  '<%= problem_id %>' per tutti gli studenti?", 
    "Reset Password": "Reimposta Password", 
    "Reset attempts for all students on problem '<%= problem_id %>'?": "Ripristino dei tentativi di tutti gli studenti per l'esercizio  '<%= problem_id %>'?", 
    ...
    "Started entrance exam rescore task for student '{student_id}'. Click the 'Show Background Task History for Student' button to see the status of the task.": "Il ricalcolo del punteggio dell'esame di ammissione per lo studente '{student_id}' \u00e8 iniziato. Seleziona il pulsante 'Show Background Task History for Student' per vedere a che punto \u00e8 il ricalcolo.", 
    "Started rescore problem task for problem '<%= problem_id %>' and student '<%= student_id %>'. Click the 'Show Background Task History for Student' button to see the status of the task.": "Il ricalcolo del punteggio dell'esercizio '<%= problem_id %>' dello studente '<%= student_id %>' \u00e8 iniziato. Seleziona il pulsante 'Show Background Task History for Student' per vedere a che punto \u00e8 il ricalcolo.", 
    "Starts": "Inizi", 
    "State": "Stato", 
    "Status": "Staus", 
    "Strikethrough": "Barrato", 
    "Student": "Studente", 
    "Student username/email field is required and can not be empty. ": "Il campo Username dello studente/email \u00e8 obbligatorio e non pu\u00f2 essere vuoto.", 
    ...
    "Success": "Successo", 
    "Success! Problem attempts reset for problem '<%= problem_id %>' and student '<%= student_id %>'.": "Azione completata con successo! Ripristino dei tentativi per l'esercizio '<%= problem_id %>' e lo studente'<%= student_id %>'.", 
    ...
    "Successfully started task to rescore problem '<%= problem_id %>' for all students. Click the 'Show Background Task History for Problem' button to see the status of the task.": "Avvio dell'attivit\u00e0 di ricalcolo del punteggio per l'esercizio  '<%= problem_id %>' per tutti  gli studenti completato con successo. Seleziona il pulsante 'Show Background Task History for Student' per vedere a che punto \u00e8 l'operazione di ricalcolo. ", 
    "Successfully started task to reset attempts for problem '<%= problem_id %>'. Click the 'Show Background Task History for Problem' button to see the status of the task.": "Avvio dell'attivit\u00e0 di ripristino dei tentativi per l'esercizio '<%= problem_id %>' completato con successo. Seleziona il pulsante 'Show Background Task History for Student' per vedere a che punto \u00e8 l'operazione di ripristino. ", 
    ...
    "The thread you selected has been deleted. Please select another thread.": "Il thread che hai selezionato \u00e8 stato cancellato. Seleziona un altro thread.", 
    ...
    "There was an error when trying to add students:": [
      "Si \u00e8 verificato un errore provando ad aggiungere gli studenti:", 
      "Si sono verificati {numErrors} errori provando ad aggiungere gli studenti:"
    ], 
    ...
    "This annotation has %(count)s flag.": [
      "Questa annotazione presenta %(counts)s flag.", 
      "Questa annotazione presenta %(counts)s flag."
    ], 
    ...
    "Type": "Tipo", 
    "URL": "URL", 
    "Unable to retrieve data, please try again later.": "Non in grado di recuperare i dati, per favore riprovare pi\u00f9 tardi.", 
    ...
    "Unknown user: {user}": "Utente: {user} sconosciuto/a", 
    ...
    "VideoPlayer: Element corresponding to the given selector was not found.": "VideoPlayer: l'elemento che corrisponde al selettore dato non \u00e8 stato trovato.", 
    "View": "Visualizza", 
    ...
    "We had some trouble closing this thread.  Please try again.": "Abbiamo incontrato qualche problema nel chiudere questa discussione. Per favore, prova di nuovo.", 
    "We had some trouble deleting this comment. Please try again.": "Abbiamo avuto alcuni problemi a cancellare questo commento. Per favore riprova.", 
    "We had some trouble loading more responses. Please try again.": "Abbiamo avuto qualche problema con il caricamento di pi\u00f9 risposte. Per favore riprovare.", 
    "We had some trouble loading more threads. Please try again.": "Abbiamo avuto qualche problema nel caricare ulteriori discussioni. Per favore, prova di nuovo.", 
    "We had some trouble loading responses. Please reload the page.": "Abbiamo avuto qualche problema con il caricamento delle risposte. Per favore ricaricare la pagina.", 
    "We had some trouble loading the discussion. Please try again.": "Abbiamo avuto qualche problema con il caricamento della discussione. Riprova pi\u00f9 tardi.", 
    "We had some trouble loading the page you requested. Please try again.": "Abbiamo avuto qualche problema con il caricamento della pagina che hai richiesto. Riprova pi\u00f9 tardi.", 
    "We had some trouble loading the threads you requested. Please try again.": "Abbiamo avuto qualche problema con il caricamento dei thread richiesti. Riprova pi\u00f9 tardi.", 
    "We had some trouble marking this response as an answer.  Please try again.": "Abbiamo avuto qualche problema a contrassegnare questa risposta come soluzione. Riprova pi\u00f9 tardi.", 
    "We had some trouble marking this response endorsed.  Please try again.": "Abbiamo incontrato qualche problema nel contrassegnare questa risposta come validata. Riprova pi\u00f9 tardi.", 
    "We had some trouble pinning this thread. Please try again.": "Abbiamo incontrato qualche problema nell'appuntare questa discussione. Per favore, prova di nuovo.", 
    "We had some trouble removing this endorsement.  Please try again.": "Abbiamo incontrato qualche problema nel rimuovere questa validazione. Riprova pi\u00f9 tardi.", 
    "We had some trouble removing this response as an answer.  Please try again.": "Abbiamo avuto qualche problema nel rimuovere questa soluzione. Riprova pi\u00f9 tardi.", 
    "We had some trouble removing your flag on this post.  Please try again.": "Abbiamo incontrato qualche problema nel rimuovere il tuo contrassegno su questo messaggio. Per favore, prova di nuovo.", 
    "We had some trouble reopening this thread.  Please try again.": "Abbiamo incontrato qualche problema nel riaprire questa discussione. Per favore, prova di nuovo.", 
    "We had some trouble reporting this post.  Please try again.": "Abbiamo incontrato qualche problema nel segnalare questo messaggio. Per favore, prova di nuovo.", 
    "We had some trouble saving your vote.  Please try again.": "Abbiamo avuto qualche problema nel salvare il tuo voto. Per favore, prova di nuovo.", 
    "We had some trouble subscribing you to this thread. Please try again.": "Abbiamo avuto qualche problema con la tua iscrizione in questo thread. Riprova pi\u00f9 tardi.", 
    "We had some trouble unpinning this thread. Please try again.": "Abbiamo incontrato qualche problema mentre derubricavamo questa discussione. Per favore, prova di nuovo.", 
    "We had some trouble unsubscribing you from this thread. Please try again.": "Abbiamo avuto qualche problema ad annullare la tua iscrizione in questo thread. Riprova pi\u00f9 tardi.", 
    ...
    "You have been logged out of your edX account. ": "Sei stato disconnesso dal tuo account edX.", 
    ...
    "e.g. 'http://google.com/'": "per esempio 'http://google.com/'", 
    ...
    "{numMoved} student was removed from {oldCohort}": [
      "{numMoved} studente \u00e8 stato rimosso da {oldCohort}", 
      "{numMoved} studenti sono stati rimossi da {oldCohort}"
    ], 
    "{numPresent} student was already in the cohort": [
      "{numPresent} studente era gi\u00e0 nel cohort", 
      "{numPresent} studenti erano gi\u00e0 nel cohort"
    ], 
    ...
    "{numUsersAdded} student has been added to this cohort": [
      "{numUsersAdded} studente \u00e8 stato aggiunto a questo cohort", 
      "{numUsersAdded} studenti sono stati aggiunti a questo cohort"
    ], 
    "{numVotes} Vote": [
      "{numVotes} Voto", 
      "{numVotes} Voti"
